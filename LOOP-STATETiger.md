...
## 当前阶段
stage 5 — Backtest harness 落地（11 个新测试，pytest 34/34 绿，commit 55b799b）；stages 6-9 待办
...
- [x] stage 5 — 评估回测（PR sweep + 阈值扫描 + HTML 报告）— `app/eval/backtest.py` + 11 测试，commit `55b799b` on `tiger/stage5-backtest-harness`
- [ ] stage 6 — 可视化三层
- [ ] stage 7 — MD 记忆体
