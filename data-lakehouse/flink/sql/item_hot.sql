...
CREATE TABLE IF NOT EXISTS default_catalog.default_database.k_user_behavior_raw2 (
  user_id BIGINT,
  item_id BIGINT,
  category_id BIGINT,
  ...
  'properties.group.id' = 'flink-consumer-itemhot-v2',
  'format' = 'json',
...
FROM default_catalog.default_database.k_user_behavior_raw2
